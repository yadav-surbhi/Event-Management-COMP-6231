...
public abstract class FEMethodPOA extends org.omg.PortableServer.Servant
 implements FEApp.FEMethodOperations, org.omg.CORBA.portable.InvokeHandler
{
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    {
       case 0:  // FEApp/FEMethod/addEvent
       {
       ...
       case 1:  // FEApp/FEMethod/removeEvent
       {
         String eventID = in.read_string ();
         String eventType = in.read_string ();
         String $result = null;
       ...
       case 2:  // FEApp/FEMethod/listEventAvailability
       {
       ...
       case 3:  // FEApp/FEMethod/bookEvent
       {
       ...
       case 4:  // FEApp/FEMethod/getBookingSchedule
       {
         String customerID = in.read_string ();
         String $result = null;
       ...
       case 5:  // FEApp/FEMethod/cancelEvent
       {
         String customerID = in.read_string ();
         String eventID = in.read_string ();
         String eventType = in.read_string ();
       ...
       case 6:  // FEApp/FEMethod/swapEvent
       {
         String customerID = in.read_string ();
  ...
  public FEMethod _this() 
  {
    return FEMethodHelper.narrow(
    super._this_object());
  }

  public FEMethod _this(org.omg.CORBA.ORB orb) 
  {
    return FEMethodHelper.narrow(
